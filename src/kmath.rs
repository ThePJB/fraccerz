...
pub static ROOT2: f64 = 1.41421356237309504880168872420969807856967187537694;
pub static ROOT2INV: f64 = 0.7071067811865475244008443621048490392848359376884740365883398689;
...
impl Vec2 {
    ...
    pub fn mag2(&self) -> f64 { self.x*self.x + self.y*self.y }
